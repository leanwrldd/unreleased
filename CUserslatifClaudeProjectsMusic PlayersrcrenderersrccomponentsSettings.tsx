          ...
          <section>
            ...
            <div className="mt-4 rounded-xl border border-[var(--border)] overflow-hidden divide-y divide-[var(--border)]">
              {([
                {
                  q: 'What is this?',
                  a: "The Juice WRLD API is a RESTful API providing access to a comprehensive database of Juice WRLD's songs, albums, and eras. Whether you're a fan, developer, or researcher, this API offers the tools you need to dive deep into Juice WRLD's music.",
                  link: { text: 'Check out the documentation to get started.', href: 'https://juicewrldapi.com/docs' },
                },
                {
                  q: 'Who are you?',
                  a: "We are passionate Juice WRLD fans and developers who wanted to create an accessible platform for others to explore and analyze Juice WRLD's musical legacy.",
                },
                {
                  q: 'Why did you build this?',
                  a: "We built this API to celebrate Juice WRLD's legacy by making his music and history more accessible to fans and developers alike.",
                },
                {
                  q: 'Technical stuff?',
