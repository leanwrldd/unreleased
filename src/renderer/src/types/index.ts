...
export type ViewType = 'api-tracker' | 'api-files' | 'api-categories' | 'editor' | 'compilation' | 'admin' | 'liked' | 'playlists' | 'shared-playlist' | 'editor-profile' | 'synced-lyrics' | 'docs' | 'not-found'
