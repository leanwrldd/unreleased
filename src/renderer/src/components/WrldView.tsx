                ...
                <div className="w-36 opacity-0 group-hover:opacity-100 transition-opacity duration-150 delay-75
                  ...
                  {playlists.slice(0, 6).map(pl => (
                    <button key={pl.id} onClick={() => handleAddToPlaylist(pl.id)} title={pl.name}
                      className="flex items-center justify-center py-3.5 rounded-lg hover:bg-white/10 transition-colors group/pl">
                      <div className="w-10 h-10 rounded-md shrink-0 bg-white/10 overflow-hidden group-hover/pl:ring-1 group-hover/pl:ring-white/30 transition-all">
